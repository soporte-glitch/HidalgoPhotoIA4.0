...
class ErrorBoundary extends Component<Props, State> {
  ...
  // This is a more explicit way to define state and can resolve issues where TypeScript
  // fails to correctly infer the component's type and its inherited properties like 'setState' and 'props'.
