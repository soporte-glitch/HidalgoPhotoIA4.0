...
const CinematicAnimator: React.FC = () => {
    ...
    const handleGenerate = async () => {
        if (!prompt || !originalImage) {
            showToast("Por favor, sube una imagen y describe la animación.", "error");
            return;
        }
        ...
        try {
            ...
            setVideoUrl(url);
            showToast("Video animado generado con éxito.", "success");
        } catch (err: any) {
            if (err.message === "API_KEY_INVALID") {
                ...
                setError(err.message || "Ocurrió un error inesperado al animar el video.");
                showToast(err.message || "Error al generar animación.", "error");
            }
    ...
    const handleDownload = () => {
        ...
        showToast("Video animado descargado.", "success");
    };
