...
const NoviaVirtual: React.FC = () => {
    ...
    const handleGenerate = async () => {
        ...
        try {
            ...
            if (result) {
                ...
                showToast("Look de novia virtual generado con éxito.", "success");
            }
            done();
        } catch(e: any) {
            fail(e.message || 'Error al crear el look virtual.');
            showToast(e.message || "Error al crear look de novia.", "error");
        }
    };
    ...
    const handleDownload = () => {
        ...
        img.onload = () => {
            ...
            link.click();
            showToast("Imagen de novia virtual descargada.", "success");
        };
    ...
    const handlePrint = () => {
        if (!generatedImage) return;
         ...
         img.onload = () => {
            ...
            showToast("Documento de novia virtual listo para imprimir.", "success");
         };
         img.src = generatedImage;
    };
