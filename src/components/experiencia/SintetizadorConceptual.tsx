...
const SintetizadorConceptual: React.FC = () => {
    ...
    const handleSynthesize = useCallback(() => {
        if (!image1 || !image2 || !prompt) {
            showToast("Sube dos imágenes de anclaje y proporciona un prompt catalizador.", "error");
            return;
        }
        runTask(async () => {
            try {
                ...
                showToast("Concepto sintetizado con éxito.", "success");
            } catch (e: any) {
                showToast(e.message || "Error al sintetizar el concepto.", "error");
                throw e;
            }
        });
    ...
    const handleDownload = () => {
        ...
        showToast("Imagen sintetizada descargada.", "success");
    };
