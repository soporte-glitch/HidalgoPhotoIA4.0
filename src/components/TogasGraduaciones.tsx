...
const TogasGraduaciones: React.FC = () => {
  ...
  const handleGenerate = async () => {
    ...
    try {
      ...
      if(result) {
        ...
        showToast("Foto de graduación generada con éxito.", "success");
      }
      done();
    } catch(e: any) {
        fail(e.message || 'Error al generar la foto de graduación.');
        showToast(e.message || "Error al generar foto de graduación.", "error");
    }
  };
  ...
  const handleDownload = () => {
    ...
    img.onload = () => {
      ...
      link.click();
      showToast("Foto de graduación descargada.", "success");
    };
      ...
      <div className="graduation-stage">
        {!imageToDisplay ? (
          ...
          <ZoomPanImageContainer>
            <img src={imageToDisplay} alt="Graduado" style={{ imageRendering: 'crisp-edges', ...imageFilterStyle }} />
          </ZoomPanImageContainer>
        )}
