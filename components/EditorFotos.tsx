...
import { editImageWithPrompt, enhanceImageTo8K } from '../services/geminiService';
import { useBusy } from '../hooks/useBusy';
import BeforeAfterSlider from './BeforeAfterSlider';
import ImageUploader from './ImageUploader';
import { WandIcon, DownloadIcon, ResetIcon, EnhanceIcon } from './Iconos';
        ...
        <div className="tools-panel avatar-box">
          ...
          <div className="panel-footer">
            ...
            <div className="button-group">
              ...
              <button onClick={handleDownload} disabled={(!editedImage && !hasManualEdits) || isLoading} className="btn-legendary">
                <DownloadIcon />
                <span>Descargar</span>
              </button>
            </div>
